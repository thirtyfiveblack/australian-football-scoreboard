    ...
    def extract_game_details(self, game_event: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            details = {
                ...
                'home_goals_number': home_team_goals.get('value', 99),
                'home_goals_name': str(home_team_goals.get('athlete', {}).get('displayName', 'Goal Test')),
                'home_disposals_number': home_team_goals.get('value', 99),
                'home_disposals_name': str(home_team_goals.get('athlete', {}).get('displayName', 'Disposal Test')),
